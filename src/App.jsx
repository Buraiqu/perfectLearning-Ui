...
import BookmarkedQuestions from './pages/Main/BookmarkedQuestions/BookmarkedQuestions';
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            <Route path="/main" >
              ...
              <Route path="bookmarked-questions/:subject/:topic" element={<BookmarkedQuestions />} />
            </Route>
          </Route>
